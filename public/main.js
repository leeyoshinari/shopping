...
const jdAppKey = '3496742e2d5a2fde480d356ec922da1e';    // 京东 app key
const jdAppSecret = '200b17a456ac4037a3dd99ad05e1a9a9';    // 京东 app secret
const jdPid = '1002712393_4100329194_3003427429';       // 京东联盟推广位id
...
const thirdJdUnionId = '1002712393';    // 好京客中授权的京东联盟ID
...
var clickActivity = (activityList, activity_platform) => {
    ...
    activityList.forEach(item => {
        if (item.expire > currentTime) {
            let sku_div = document.createElement('div');
            sku_div.innerHTML = `<span>${item.title?item.title:""}</span><img src=${item.imgUrl} alt="" />`;
